...
var createUseLens = /* @__PURE__ */ __name((proxy) => /* @__PURE__ */ __name(function useLens(shouldUpdate = SHOULD_ALWAYS_RETURN_NEXT) {
  import_react.default.useDebugValue(proxy.$key);
  const store = import_react.default.useMemo(() => proxy.getStore(), [proxy]);
  const shouldUpdateFn = import_react.default.useMemo(() => shouldUpdateToFunction(shouldUpdate), [shouldUpdate]);
  const prevStateRef = import_react.default.useRef(NOTHING);
